...
| SearchSurveys | [SearchSurveyRequest](#com.cognite.seismic.SearchSurveyRequest) | [SurveyWithFilesResponse](#com.cognite.seismic.SurveyWithFilesResponse) | Search surveys based on two criteria: Coverage polygon of files in the survey are within an area delimited by a specified polygon Filters on metadata of both the survey and the file Both criteria are optional and can be combined for a more detailed search. |
